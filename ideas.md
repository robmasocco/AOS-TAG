...
- After initial tests work, check if operations in *TAG_COND_REG* and *TAG_COND_FLIP* really need to be atomic since we're holding a spinlock: test correctness and performance.
